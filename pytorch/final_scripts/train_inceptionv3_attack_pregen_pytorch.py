...
def inceptionv3_attack_pregen_training():

    # Define the Resmodel model
    load_ep_num = 0
    # model = torch.load(f'saved_model/inceptionv3_pdg_training/inceptionv3_ep_{load_ep_num}_pdg_trained.pth')
    # model = torch.load(f'saved_model/inceptionv3_training/inceptionv3_best_model.pth')
    # model = torch.load(f'/mnt/task_runtime/saved_model/inceptionv3_attack_pregen_training/inceptionv3_attack_pregen_best_model_backup.pth')
    # model = torch.load(f'saved_model/inceptionv3_attack_pregen_training/inceptionv3_attack_pregen_best_model_2.pth')
    premodel = torch.load(f'/mnt/task_runtime/saved_model/inceptionv3_training/inceptionv3_best_model.pth')
    model = torch.load(f'saved_model/inceptionv3_attack_pregen_training/inceptionv3_attack_pregen_best_model_backup.pth')
    ...
    patience = 3
    num_epochs = 100
    save_model_dir = "saved_model/inceptionv3_attack_pregen_training_final/"
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model, f'{save_model_dir}/inceptionv3_ep_{epoch+1}_attack_pregen_trained.pth')
        print(f"Saved {save_model_dir}/inceptionv3_ep_{epoch+1}_attack_pregen_trained.pth")
    ...
    torch.save(model, f'{save_model_dir}/inceptionv3_attack_pregen_best_model.pth')
    print(f"Saved {save_model_dir}/inceptionv3_attack_pregen_best_model.pth")

def model_evaluation():
    premodel = torch.load(f'/mnt/task_runtime/saved_model/inceptionv3_training/inceptionv3_best_model.pth')
    model = torch.load(f'saved_model/inceptionv3_attack_pregen_training/inceptionv3_attack_pregen_best_model_backup.pth')
    # premodel = torch.load(f'saved_model/inceptionv3_attack_pregen_training/inceptionv3_attack_pregen_best_model_2.pth')
    # model = torch.load(f'saved_model/inceptionv3_attack_pregen_training/inceptionv3_attack_pregen_best_model.pth')
...
inceptionv3_attack_pregen_training()