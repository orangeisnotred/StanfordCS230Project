...
def resnet101_attack_pregen_training():

    # Define the Resmodel model
    load_ep_num = 0
    # model = torch.load(f'saved_model/resnet101_pdg_training/resnet101_ep_{load_ep_num}_pdg_trained.pth')
    # model = torch.load(f'saved_model/resnet101_training/resnet101_best_model.pth')
    # model = torch.load(f'/mnt/task_runtime/saved_model/resnet101_attack_pregen_training/resnet101_attack_pregen_best_model_backup.pth')
    # model = torch.load(f'saved_model/resnet101_attack_pregen_training/resnet101_attack_pregen_best_model_2.pth')
    premodel = torch.load(f'/mnt/task_runtime/saved_model/resnet101_training/resnet101_best_model.pth')
    model = torch.load(f'saved_model/resnet101_attack_pregen_training/resnet101_attack_pregen_best_model_backup.pth')
    ...
    patience = 3
    num_epochs = 100
    save_model_dir = "saved_model/resnet101_attack_pregen_trainin_final/"
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model, f'{save_model_dir}/resnet101_ep_{epoch+1}_attack_pregen_trained.pth')
        print(f"Saved {save_model_dir}/resnet101_ep_{epoch+1}_attack_pregen_trained.pth")
    ...
    torch.save(model, f'{save_model_dir}/resnet101_attack_pregen_best_model.pth')
    print(f"Saved {save_model_dir}/resnet101_attack_pregen_best_model.pth")

def model_evaluation():
    premodel = torch.load(f'/mnt/task_runtime/saved_model/resnet101_training/resnet101_best_model.pth')
    model = torch.load(f'saved_model/resnet101_attack_pregen_training/resnet101_attack_pregen_best_model_backup.pth')
    # premodel = torch.load(f'saved_model/resnet101_attack_pregen_training/resnet101_attack_pregen_best_model_2.pth')
    # model = torch.load(f'saved_model/resnet101_attack_pregen_training/resnet101_attack_pregen_best_model.pth')
...
resnet101_attack_pregen_training()