...
def resnet50_attack_pregen_training():
    ...
    load_ep_num = 0
    # model = torch.load(f'saved_model/resnet50_pdg_training/resnet50_ep_{load_ep_num}_pdg_trained.pth')
    # model = torch.load(f'saved_model/resnet50_training/resnet50_best_model.pth')
    # model = torch.load(f'/mnt/task_runtime/saved_model/resnet50_attack_pregen_training/resnet50_attack_pregen_best_model_backup.pth')
    # model = torch.load(f'saved_model/resnet50_attack_pregen_training/resnet50_attack_pregen_best_model_3.pth')
    premodel = torch.load(f'/mnt/task_runtime/saved_model/resnet50_training/resnet50_best_model.pth')
    model = torch.load(f'/mnt/task_runtime/saved_model/resnet50_attack_pregen_training/resnet50_attack_pregen_best_model_backup.pth')
    ...
    patience = 3
    num_epochs = 100
    save_model_dir = "saved_model/resnet50_attack_pregen_training_final/"
...
def model_evaluation():
    ...
    premodel = torch.load(f'/mnt/task_runtime/saved_model/resnet50_training/resnet50_best_model.pth')
    model = torch.load(f'/mnt/task_runtime/saved_model/resnet50_attack_pregen_training/resnet50_attack_pregen_best_model_backup.pth')
    # premodel = torch.load(f'saved_model/resnet50_attack_pregen_training/resnet50_attack_pregen_best_model_3.pth')
    # model = torch.load(f'saved_model/resnet50_attack_pregen_training/resnet50_attack_pregen_best_model.pth')
