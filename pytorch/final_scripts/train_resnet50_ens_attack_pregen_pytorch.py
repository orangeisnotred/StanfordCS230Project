...
def resnet50_attack_pregen_training():

    # Define the Resmodel model
    load_ep_num = 0
    # model = torch.load(f'saved_model/vgg16_pdg_training/vgg16_ep_{load_ep_num}_pdg_trained.pth')
    # vgg16_model = torch.load('saved_model/vgg16_ens_pdg_training/vgg16_ep_8_ens_pdg_trained.pth')
    vgg16_model = torch.load('saved_model/vgg16_best_model.pth')
    # resnet50_model = torch.load('saved_model/resnet50_ens_attack_pregen_training/resnet50_attack_pregen_best_model_2.pth')
    resnet50_premodel = torch.load(f'/mnt/task_runtime/saved_model/resnet50_best_model.pth')
    resnet50_model = torch.load(f'/mnt/task_runtime/saved_model/resnet50_ens_attack_pregen_training/resnet50_attack_pregen_best_model_1.pth')
    ...
    resnet50_premodel = resnet50_premodel.to(device)
    ...
    patience = 3
    num_epochs = 100
    save_model_dir = "saved_model/resnet50_ens_attack_pregen_training_final/"
    os.makedirs(save_model_dir, exist_ok=True)
    

    train_adv_dataset_list=[]
    test_adv_dataset_list=[]
    train_adv_dataset=[]
    test_adv_dataset=[]
    batch = 0
    for images, labels in train_loader:
        ...
        adv_images = projected_gradient_descent(vgg16_model, images, eps=0.1, eps_iter=0.01, nb_iter=10, norm=np.inf)
        train_adv_dataset.append([adv_images, labels])
        batch += 1

        if batch == 100:
            break
    train_adv_dataset_list.append(train_adv_dataset)
    ...
    for images, labels in test_loader:
        ...
        # if batch == 10:
        #     break
    test_adv_dataset_list.append(test_adv_dataset)
    ...
    for images, labels in train_loader:
        ...
        adv_images = projected_gradient_descent(resnet50_premodel, images, eps=0.1, eps_iter=0.01, nb_iter=10, norm=np.inf)
        train_adv_dataset.append([adv_images, labels])
        batch += 1
    ...
    for images, labels in train_loader:
        ...
        adv_images = projected_gradient_descent(resnet101_model, images, eps=0.1, eps_iter=0.01, nb_iter=10, norm=np.inf)
        train_adv_dataset.append([adv_images, labels])
        batch += 1
    ...
    for epoch in range(num_epochs):
        ...
        for images, labels in train_loader:
            ...
            train_adv_dataset = train_adv_dataset_list[rand_num]
        ...
        for images, labels in test_loader:
            ...
            # eval adv
        for images, labels in test_adv_dataset_list[1]:
        ...
        torch.save(model, f'{save_model_dir}/resnet50_ep_{epoch+1}_attack_pregen_trained.pth')
        print(f"Saved {save_model_dir}/resnet50_ep_{epoch+1}_attack_pregen_trained.pth")
    ...
    torch.save(model, f'{save_model_dir}/resnet50_attack_pregen_best_model.pth')
    print(f"Saved {save_model_dir}/resnet50_attack_pregen_best_model.pth")


def model_evaluation():
    # premodel = torch.load(f'saved_model/resnet50_ens_attack_pregen_training/resnet50_attack_pregen_best_model_2.pth')
    # model = torch.load(f'saved_model/resnet50_ens_attack_pregen_training/resnet50_attack_pregen_best_model.pth')
    premodel = torch.load(f'/mnt/task_runtime/saved_model/resnet50_best_model.pth')
    model = torch.load(f'/mnt/task_runtime/saved_model/resnet50_ens_attack_pregen_training/resnet50_attack_pregen_best_model_1.pth')
...
resnet50_attack_pregen_training()