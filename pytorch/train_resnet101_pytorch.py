...
def resnet101_training():
    ...
    patience = 3
    num_epochs = 50
    save_model_dir = "saved_model/resnet101_training/"
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model, f'{save_model_dir}/resnet101_ep_{epoch+1}.pth')
        print(f"Saved {save_model_dir}/resnet101_ep_{epoch+1}.pth")
    ...
    torch.save(model, f'{save_model_dir}/resnet101_best_model.pth')
    print(f"Saved {save_model_dir}/resnet101_best_model.pth")