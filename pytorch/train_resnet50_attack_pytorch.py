...
def resnet50_attack_training():
    ...
    patience = 3
    num_epochs = 50
    save_model_dir = "saved_model/resnet50_pdg_training/"
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model, f'{save_model_dir}/resnet50_ep_{epoch+1}_pdg_trained.pth')
        print(f"Saved {save_model_dir}/resnet50_ep_{epoch+1}_pdg_trained.pth")
    ...
    torch.save(model, f'{save_model_dir}/resnet50_best_model_pdg_trained.pth')
    print(f"Saved {save_model_dir}/resnet50_best_model_pdg_trained.pth")