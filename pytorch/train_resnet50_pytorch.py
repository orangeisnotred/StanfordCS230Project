...
def resnet50_training():
    ...
    patience = 3
    num_epochs = 50
    save_model_dir = "saved_model/resnet50_training/"
    ...
    torch.save(model, f'{save_model_dir}/resnet50_best_model.pth')
    print(f"Saved {save_model_dir}/resnet50_best_model.pth")