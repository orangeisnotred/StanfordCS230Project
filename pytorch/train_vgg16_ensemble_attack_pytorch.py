...
def vgg16_ensemble_attack_training():
    ...
    patience = 3
    num_epochs = 50
    save_model_dir = "saved_model/vgg16_ens_pdg_training/"
    ...
    for epoch in range(num_epochs):
        ...
        for images, labels in test_loader:
            ...
            model = models[rand_num]
            adv_images = projected_gradient_descent(model, images, eps=0.3, eps_iter=0.01, nb_iter=40, norm=np.inf)
            adv_outputs = vgg16_model(adv_images)
        ...
        torch.save(model, f'{save_model_dir}/vgg16_ep_{epoch+1}_ens_pdg_trained.pth')
    ...
    torch.save(model, f'{save_model_dir}/vgg16_best_model_ens_pdg_trained.pth')
    print(f"Saved {save_model_dir}/vgg16_best_model_pdg_ens_trained.pth")
