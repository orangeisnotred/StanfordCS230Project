...
def vgg16_training():
    ...
    patience = 3
    num_epochs = 50
    save_model_dir = "saved_model/vgg16_training/"
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model, f'{save_model_dir}/vgg16_ep_{epoch+1}.pth')
        print(f"Saved {save_model_dir}/vgg16_ep_{epoch+1}.pth")
    ...
    torch.save(model, f'{save_model_dir}/vgg16_best_model.pth')
    print(f"Saved {save_model_dir}/vgg16_best_model.pth")